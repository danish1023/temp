...
function drawScale() {
  ...
  for (var sa = -180; sa <= 0; sa += 45) {
    ...
    if (n == 0) {
      scaleText.innerHTML = "Bronze";

    }
    if (n == 1) {
      scaleText.textContent = "Silver";
    }
    if (n == 2) {
      scaleText.textContent = "Gold";
    }
    if (n == 3) {
      scaleText.textContent = "Diamond";
    }
    if (n == 4) {
      scaleText.textContent = "Car";
    }
